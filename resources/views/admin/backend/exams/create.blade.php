...
<div id="Web_1920__1">
	<div id="Group_18">
		...
		<svg class="Rectangle_2">
			<img class="Rectangle_2" src="{{asset('storage/uploads/image/'.$form->image)}}" style="z-index:1;" width="217" height="217"><rect id="Rectangle_2" rx="49" ry="49" x="0" y="0" width="217" height="217">
			</rect>
		</svg>
		...
		<div id="registration_no">
			<span>{{$form->regd_no}}</span>
		</div>
		<div id="faculty">
			<span>{{$form->faculty}}</span>
		</div>
		<div id="exam_year">
			<span>{{$form->year}}</span>
		</div>
		...
		<svg class="Rectangle_8">
			<img class="Rectangle_8" src="{{asset('storage/uploads/signature/'.$form->signature)}}" width="257" height="74"><rect id="Rectangle_8" rx="0" ry="0" x="0" y="0" width="257" height="74">
			</rect>
		</svg>
		<svg class="Rectangle_9">
			<img class="Rectangle_9" src="{{asset('storage/uploads/signature/'.$form->signature)}}" width="257" height="74"><rect id="Rectangle_9" rx="0" ry="0" x="0" y="0" width="257" height="74">
			</rect>
        </svg>
        ...
        @foreach(json_decode($form->subjects) as $key=>$subject)
		@if($subject!==null)
        <div id="Group_{{9+$key}}">
			<div id="sn_cg">
				<span>{{$key+1}}</span>
			...
			<div id="sub_code_ci">
				<span><?php $c=json_decode($form->subject_codes); echo $c[$key]; ?></span>
			</div>
        </div>
        @endif
        @endforeach
