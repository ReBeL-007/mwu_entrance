...
<body>
    ...
    array_push($regular, $exam);
    }elseif ($exam->exam_type === 'Partial') {
    array_push($partial, $exam);
    }else {
    array_push($chance, $exam);
    }
    }
    @endphp
    @if(count($regular) > 0)
        ...
        <table class="table table-striped triplicate-table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    @endforeach
                    @for($i = 1; $i <= $count - count(json_decode($exam->subject_codes)); $i++)
                        <td></td>
                        @endfor
                </tr>
                @endforeach
